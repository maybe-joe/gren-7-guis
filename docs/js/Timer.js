...
var $author$project$Timer$init = function(_v0) {
	return { command: $gren_lang$core$Platform$Cmd$none, model: { limit: 30, tick: 0 } };
};
...
var $author$project$Timer$subscriptions = function(model) {
	return (_Utils_cmp(model.tick, model.limit) < 0) ? $gren_lang$core$Time$every$(100, $author$project$Timer$Tick) : $gren_lang$core$Platform$Sub$none;
};
...
var $author$project$Timer$update$ = function(msg, model) {
	switch (msg.$) {
		case 'Tick':
			return _Utils_update(model, { tick: model.tick + 1 });
		case 'OnInputDuration':
			var value = msg.a;
			return _Utils_update(model, { limit: $gren_lang$core$Maybe$withDefault$(0, $gren_lang$core$String$toFloat(value)) });
		default:
			return _Utils_update(model, { tick: 0 });
	}
};
var $author$project$Timer$update = F2($author$project$Timer$update$);
var $author$project$Timer$OnClickReset = { $: 'OnClickReset' };
var $author$project$Timer$OnInputDuration = function (a) {
	return { $: 'OnInputDuration', a: a };
};
...
var $author$project$Timer$formatSeconds = function(value) {
	var seconds = $gren_lang$core$String$fromFloat(value / 10);
	return A2($gren_lang$core$String$contains, '.', seconds) ? (seconds + 's') : (seconds + '.0s');
};
...
var $gren_lang$browser$Html$progress = $gren_lang$browser$Html$node('progress');
...
var $author$project$Timer$view = function(model) {
	var value = $gren_lang$core$String$fromFloat(model.tick);
	var max = $gren_lang$core$String$fromFloat(model.limit);
	return $author$project$Layout$box([ $author$project$Layout$stack([ $author$project$Layout$cluster([ A2($gren_lang$browser$Html$p, [  ], [ $gren_lang$browser$Html$text($author$project$Timer$formatSeconds(model.tick)) ]), A2($gren_lang$browser$Html$p, [  ], [ $gren_lang$browser$Html$text($author$project$Timer$formatSeconds(model.limit)) ]) ]), A2($gren_lang$browser$Html$progress, [ $gren_lang$browser$Html$Attributes$value(value), $gren_lang$browser$Html$Attributes$max(max) ], [  ]), A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$type_('range'), $gren_lang$browser$Html$Attributes$value(max), $gren_lang$browser$Html$Attributes$max('100'), $gren_lang$browser$Html$Events$onInput($author$project$Timer$OnInputDuration) ], [  ]), A2($gren_lang$browser$Html$button, [ $gren_lang$browser$Html$Events$onClick($author$project$Timer$OnClickReset) ], [ $gren_lang$browser$Html$text('Reset') ]) ]) ]);
};
var $author$project$Timer$main = $gren_lang$browser$Browser$element({ init: $author$project$Timer$init, subscriptions: $author$project$Timer$subscriptions, update: F2(function(msg, model) {
			return { command: $gren_lang$core$Platform$Cmd$none, model: $author$project$Timer$update$(msg, model) };
		}), view: $author$project$Timer$view });
_Platform_export({'Timer':{'init':$author$project$Timer$main($gren_lang$core$Json$Decode$succeed({  }))(0)}});}(this.module ? this.module.exports : this));